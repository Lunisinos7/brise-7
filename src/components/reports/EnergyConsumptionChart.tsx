  ...
  return <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          <Zap className="h-5 w-5 text-primary bg-card" />
      ...
      <CardContent className="h-80">
        {isLoading ? <div className="h-full flex items-center justify-center">
            ...
            borderRadius: "8px"
              ...
              <Area type="monotone" dataKey="consumption" stroke="hsl(var(--primary))" strokeWidth={2} fillOpacity={1} fill="url(#colorConsumption)" />
            </AreaChart>
          </ResponsiveContainer>}
      </CardContent>
    </Card>;
