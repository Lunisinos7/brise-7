...
const Settings = () => {
  ...
  const applyTheme = (theme: Theme) => {
    ...
    root.classList.remove('theme-dark', 'theme-green-light', 'theme-green-dark', 'theme-red', 'theme-red-dark', 'theme-purple', 'theme-purple-dark');
  ...
  const renderThemeOption = (theme: ThemeOption) => <div key={theme.id} className="flex items-center space-x-3">
  ...
  return <div className="p-6 space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <RadioGroup value={selectedTheme} onValueChange={handleThemeChange} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Light Themes Column */}
